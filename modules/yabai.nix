...
lib.mkIf pkgs.stdenv.isDarwin {
  ...
  home.activation = {
    yabaiInstall = lib.hm.dag.entryAfter [ "linkGeneration" ] ''
      ${locateBrew}
      if [ -z "$BREW" ]; then
    ...
    yabaiMissionControl = lib.hm.dag.entryAfter [ "yabaiInstall" ] ''
    ...
    yabaiService = lib.hm.dag.entryAfter [ "yabaiMissionControl" ] ''
    ...
    yabaiSudoers = lib.hm.dag.entryAfter [ "yabaiService" ] ''
